...
class LocationProvider with ChangeNotifier {
  ...
  Position _position = Position(altitudeAccuracy: 3, headingAccuracy: 3, longitude: 0, latitude: 0, timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1);
  Position _pickPosition = Position(altitudeAccuracy: 3, headingAccuracy: 3, longitude: 0, latitude: 0, timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1);
  bool _loading = false;
  ...
  void updatePosition(CameraPosition? position, bool fromAddress, String? address, BuildContext context) async {
    if(_updateAddAddressData) {
      ...
      try {
        if (fromAddress) {
          _position = Position(
            altitudeAccuracy: 3, headingAccuracy: 3, 
