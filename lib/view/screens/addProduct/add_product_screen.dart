...
class AddProductScreenState extends State<AddProductScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _tabController =
        TabController(length: Provider.of<SplashProvider>(context, listen: false).configModel!.languageList!.length, initialIndex: 0, vsync: this);
    ...
    if (widget.product != null) {
      ...
      Provider.of<SellerProvider>(context, listen: false)
          .setDigitalProductTypeIndex(widget.product!.digitalProductType == "ready_after_sell" ? 0 : 1, false);
    } else {
      Provider.of<SellerProvider>(context, listen: false)
      ...
      body: Consumer<SellerProvider>(
        builder: (context, resProvider, child) {
          ...
          return widget.product != null && resProvider.editProduct == null
              ...
              : length != null
                  ? Consumer<SplashProvider>(builder: (context, splashController, _) {
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: TabBar(
                                ...
                                indicatorWeight: 5,
                                indicator: BoxDecoration(border: Border(bottom: BorderSide(color: Theme.of(context).primaryColor, width: 2))),
                                labelColor: Theme.of(context).primaryColor,
                                unselectedLabelColor: ColorResources.getTextColor(context),
                                unselectedLabelStyle:
                                    robotoRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeLarge),
                            ...
                            Provider.of<SplashProvider>(context, listen: false).configModel!.digitalProductSetting == "1"
                                ? DigitalProductWidget(resProvider: resProvider, product: widget.product)
                                : const SizedBox(),
                            Container(
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      Text(getTranslated('product_code_sku', context)!,
                                          style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                                      Text(
                                        '*',
                                        style: robotoBold.copyWith(
                                            color: ColorResources.mainCardFourColor(context), fontSize: Dimensions.fontSizeDefault),
                                      ),
                                      const Spacer(),
                                      InkWell(
                                          onTap: () {
                                          ...
                                          child: Text(getTranslated('generate_code', context)!,
                                              style: robotoRegular.copyWith(
                                                  fontSize: Dimensions.fontSizeDefault, color: ColorResources.mainCardFourColor(context)))),
                                    ],
                                  ),
                                  const SizedBox(height: Dimensions.paddingSizeSmall),
                                  CustomTextField(
                            ...
                            SizedBox(
                                height: Provider.of<SplashProvider>(context, listen: false).configModel!.brandSetting == "1"
                                ...
                                ? Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Text(getTranslated('select_brand', context)!,
                                                style: robotoRegular.copyWith(
                                          ...
                                          child: DropdownButton<int>(
                                            ...
                                            items: brandIds.map((int? value) {
                                              return DropdownMenuItem<int>(
                                                ...
                                                child: Text(value != 0
                                                    ? resProvider.brandList![(brandIds.indexOf(value) - 1)].name!
                                ...
                                ? Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Text(getTranslated('select_unit', context)!,
                                                style: robotoRegular.copyWith(
                                                    color: ColorResources.titleColor(context), fontSize: Dimensions.fontSizeDefault)),
                                            Text(
                                              '*',
                                        ...
                                        Container(
                                          ...
                                          child: DropdownButton<String>(
                                            ...
                                            onChanged: (val) {
                                              ...
                                              setState(
                                                () {
                                                  resProvider.setValueForUnit(val);
                                                },
                                              );
                                            },
                                            isExpanded: true,
                  ...
                  child: InkWell(
                            ...
                            MaterialPageRoute(
                                builder: (_) => AddProductNextScreen(
                                    ...
                                    subCategoryId: resProvider.subCategoryIndex != 0
                                        ? resProvider.subCategoryList![resProvider.subCategoryIndex! - 1].id.toString()
                                        : "-1",
                                    subSubCategoryId: resProvider.subSubCategoryIndex != 0
                                        ? resProvider.subSubCategoryList![resProvider.subSubCategoryIndex! - 1].id.toString()
                                        : "-1",
                    ...
                    child: Container(
                      ...
                      child: const Center(
                          child: Text(
                        'Continue',
                        style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: Dimensions.fontSizeLarge),
                      )),
                    ),
                  ),
                )
