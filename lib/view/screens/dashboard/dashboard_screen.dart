          ...
          onTap: (int index) {
            if (index != 3) {
              ...
              showModalBottomSheet(
                  context: context, isScrollControlled: true, backgroundColor: Colors.transparent, builder: (con) => const MenuBottomSheet());
            }
          },
        ),
    ...
    return BottomNavigationBarItem(
      icon: Padding(
        ...
        child: Stack(
          ...
          children: [
            SizedBox(
                width: index == _pageIndex ? Dimensions.iconSizeLarge : Dimensions.iconSizeMedium,
                child: Image.asset(
                  icon,
                  color: index == _pageIndex ? Theme.of(context).primaryColor : ColorResources.hintTextColor,
                )),
          ],
        ),
      ),
